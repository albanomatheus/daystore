...
<?php elseif (isset($_GET['cod']) and $_SESSION['admin_id'] == $_GET['num']): ?>
    <a href="<?php echo "?page=admin&num={$_GET['num']}&cod=1"; ?>">
        <button class='searchButton' style="width: 33%; margin-bottom: 5px; font-size: 18px;">Upload</button>
    </a>
    <a href="<?php echo "?page=admin&num={$_GET['num']}&cod=2"; ?>">
        <button class='searchButton' style="width: 33%; margin-bottom: 5px; font-size: 18px;">Usuários</button>
    </a>
    <a href="<?php echo "?page=admin&num={$_GET['num']}&cod=3"; ?>">
        <button class='searchButton' style="width: 33%; margin-bottom: 5px; font-size: 18px;">Deletar</button>
    </a>
    ...
    <?php if ($_GET['cod'] == "1"): ?>
        <form action="_back/validation/admin.php?key=upload" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    <label>Arquivo:</label>
                    <input type="file" name="img" style="padding: 0px; border: 0px; margin-bottom: 0px; height: auto;">
                </div>
